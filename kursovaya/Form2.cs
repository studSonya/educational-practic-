...
namespace kursovaya
{
    ...
    public partial class Admin : Form
    {
        ...
        private void Admin_Load(object sender, EventArgs e)
        {
            ...
            //"WHERE IDМаршрут=КодМаршрута AND Города.Город=Месторасположения AND '"+comboBox6.Text+"'=Месторасположения AND (ПунктОтправления=КодАэропорты OR ПунктПрибытия=КодАэропорты)";

            //str = "SELECT Месторасположения, (SELECT ПунктПрибытия FROM Маршрут WHERE ПунктОтправления=" + id+")FROM Аэропорты ";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            товарTableAdapter.Update(this.db.Товар) ;
        }
